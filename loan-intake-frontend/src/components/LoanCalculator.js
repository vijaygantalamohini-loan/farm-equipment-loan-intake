...
function BorrowerInfoStep({
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8 bg-white">
      {/* Header */}
      <div className="mb-8">
              ...
              <div>
                ...
                {farmLegalEntitySelectValue === OTHER_OPTION_VALUE && (
                  <input
                    ...
                    className={`w-full px-3 py-2 border rounded-lg mt-2 focus:outline-none focus:ring-2 focus:ring-black ${
                      farmLegalEntityOtherHasError ? "border-red-500" : "border-gray-300"
                    }`}
                  />
                )}
  ...
  return (
    <div>
      ...
      <input
        ...
        onBlur={onBlur}
        maxLength={maxLength}
        className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-black transition ${
